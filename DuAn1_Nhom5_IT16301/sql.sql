...
GO
insert taikhoan values ('SyHQ','123',1,'NV01',1)
...
insert NHANVIEN values ('NV01','SyHQ','2002/03/24','0000000000','00000000',1,'BT')
...
ALTER TABLE TAIKHOAN  ADD FOREIGN KEY(MANV) REFERENCES NHANVIEN(MANV) ON DELETE CASCADE ON UPDATE CASCADE
